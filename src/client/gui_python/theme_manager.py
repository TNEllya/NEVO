...
LIGHT_PALETTE = {
    ...
    "bg_input_hover": "rgba(0, 0, 0, 0.08)",
    "bg_input_pressed": "rgba(0, 0, 0, 0.12)",
    "bg_overlay": "rgba(0, 0, 0, 0.08)",
    "bg_hover": "rgba(0, 0, 0, 0.06)",
    "bg_inner_card": "#e8eaed",
    "bg_status": "rgba(0, 0, 0, 0.04)",
    "text_primary": "#2e3033",
    "text_secondary": "#5c5f66",
    "text_muted": "#8a8d94",
    "text_timestamp": "#9ca0a8",
    "text_system_msg": "#9ca0a8",
    "text_white": "#2e3033",
    "text_accent": "#2d8f5e",
    "text_warning": "#c4850c",
    "border_dashed": "#c5c8ce",
    "border_avatar": "#d0d3d9",
    "bg_avatar_empty": "#e0e2e6",
